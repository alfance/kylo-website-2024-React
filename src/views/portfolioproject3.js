        ...
        <div className="portfolioproject3-portfolio1">
          ...
          <div className="portfolioproject3-project-myrole">
              ...
              <div className="portfolioproject3-headline-subhead02">
                <div className="portfolioproject3-headline-subhead03">
                  ...
                  <div className="portfolioproject3-graphtext">
                    <span className="portfolioproject3-text08">
                      <span className="portfolioproject3-text09">
                        project objectives and user pain points
                      </span>
                      <span className="portfolioproject3-text10">
                        user interviews
                      </span>
                      <span className="portfolioproject3-text11">
                        Overseeing the development
                      </span>
                      <span className="portfolioproject3-text12">
                        integrate feedback and refine design concepts
                      </span>
                      <span>
                      ...
                      <span> to guide the design direction.</span>
                      <br></br>
                      <span>
                        Conducting
                        <span
                      ...
                      <span>
                        {' '}
                        of user interfaces and flows, ensuring a seamless and
                      ...
                      <br></br>
                      <span>
                        Streamlining the deployment and improving efficiency and
                        user satisfaction.
                      </span>
                    </span>
                  </div>
            ...
            <div className="portfolioproject3-stickerfinallayer1-locked-aspect-ratio">
              <img
                alt="stickerfinallayer1I546"
                src="/external/stickerfinallayer1i546-rus4f-1500w.png"
                className="portfolioproject3-stickerfinallayer11 image-contain"
              />
              <div className="portfolioproject3-frame"></div>
            </div>
          </div>
          <div className="portfolioproject3-headertitle">
            <span className="portfolioproject3-text28 Epilogue-36Light">
              <span>Projects</span>
            </span>
          </div>
            ...
            <div className="portfolioproject3-header1 Epilogue-17 content-divide">
              <div className="portfolioproject3-headline-subhead04 content-divide-child">
                <div className="portfolioproject3-headline-subhead05">
                  ...
                  <span className="portfolioproject3-text30 Epilogue-36Bold">
                ...
                >
                  <span className="portfolioproject3-text38">
          ...
          <div className="portfolioproject3-project-myrole1">
                ...
                <div className="portfolioproject3-headline-subhead11">
                  ...
                  <div className="portfolioproject3-graphtext1">
                    <span className="portfolioproject3-text60 Bodytext">
                      ...
                      <br></br>
                      <span>
                        There are 3 fundamental building blocks for the cluster
                        rendering. I managed the comprehensive design of the
                        interface and user flow: the internal Unity package for
                        multi-machine live editing, the web application for
                        deploying and monitoring the cluster system, and
                        enhancements to third-party clustering solutions.
                      </span>
                    </span>
                  </div>
                </div>
            ...
            <div className="portfolioproject3-stickerfinallayer1-locked-aspect-ratio1">
              <img
                ...
                src="/external/stickerfinallayer1i737-gh9d-1500w.png"
